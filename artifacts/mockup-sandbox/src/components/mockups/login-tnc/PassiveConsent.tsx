...
export function PassiveConsent() {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-emerald-400/30 rounded-2xl p-8 shadow-2xl">
          ...
          <button className="w-full bg-white text-gray-800 rounded-xl px-5 py-3 text-sm font-semibold flex items-center justify-center gap-3 hover:bg-gray-100 hover:-translate-y-0.5 hover:shadow-md active:scale-[0.98] transition-all duration-150 shadow-sm cursor-pointer">
          ...
          <p className="text-white/40 text-xs text-center mt-4 leading-relaxed">
            ...
            <a href="#" className="text-emerald-400/80 hover:text-emerald-300 underline underline-offset-2" onClick={e => e.preventDefault()}>
              Terms & Conditions
            </a>{" "}
            and{" "}
            <a href="#" className="text-emerald-400/80 hover:text-emerald-300 underline underline-offset-2" onClick={e => e.preventDefault()}>
